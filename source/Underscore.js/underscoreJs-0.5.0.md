...
> code source   :       [https://github.com/jashkenas/underscore/blob/v1.9.0/underscore.js](https://github.com/jashkenas/underscore/blob/v0.5.0/underscore.js)
...
(function() {
    ...
    // 以下是各种挂载在 _ 上的函数操作, 具体实现自行阅读. 大部分比较简单. 部分地方加有注释. 
    ...
    _.rest = function(array, index) {
        return Array.prototype.slice.call(array, _.isUndefined(index)
            ? 1
            : index);
    };
